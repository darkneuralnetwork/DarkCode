...
var descriptors = []Field{
	...
	{Name: "memory_profile", Label: "Local context size", Group: "Models", Tier: TierDerived, Kind: "string",
		Choices: []string{"lean", "balanced", "max", ""}},
	{Name: "temperature", Label: "Temperature", Group: "Models", Tier: TierDerived, Kind: "float"},
	{Name: "max_turns", Label: "Max turns", Group: "Execution", Tier: TierDerived, Kind: "int"},
	{Name: "max_concurrent", Label: "Max concurrency", Group: "Execution", Tier: TierDerived, Kind: "int"},
	{Name: "execution_profile", Label: "Execution profile", Group: "Execution", Tier: TierDerived, Kind: "string",
	...
	{Name: "plan_depth", Label: "Planning depth", Group: "Execution", Tier: TierDerived, Kind: "string"},
	...
	{Name: "approval_timeout_seconds", Label: "Approval timeout", Group: "Autonomy", Tier: TierDerived, Kind: "int"},
	...
	{Name: "extension_dirs", Label: "Extension directories", Group: "Tools", Tier: TierAdvanced, Kind: "list"},
	{Name: "episodic_max_entries", Label: "History size", Group: "Storage", Tier: TierDerived, Kind: "int",
		Help: "How many past runs to keep. Evicted by disuse, not age."},
	{Name: "health_cpu_percent", Label: "Background CPU share", Group: "Autonomy", Tier: TierDerived, Kind: "int"},
	...
	{Name: "embedded_context_size", Label: "Embedded context size", Group: "Models", Tier: TierDerived, Kind: "int"},
	{Name: "embedded_idle_timeout_minutes", Label: "Embedded idle timeout", Group: "Models", Tier: TierDerived, Kind: "int"},
